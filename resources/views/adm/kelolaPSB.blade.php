                    ...
                    <div class="col-sm-4">
                        <div class="page-header float-left">
                            <div class="page-title">
                                <h1>Data Pembayaran Siswa Baru</h1>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-8">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Data PSB</strong>
                            </div>
                        
                            <div class="card-body">

                                <div class="col-md-6">
                                    <a href="/admin/datapembayaran/psb/reset" class="btn btn-danger mb-1"><i class="fa fa-trash"></i>
                                      Reset Data
                                    </a>     
                                </div>
                                ...
                                <table id="bootstrap-data-table" class="table table-striped table-bordered" >
                                    ...
                                    <tbody>
                                    @if(!empty($psb))
                                    @for($i=0; $i<count($psb); $i++)
                                        <tr>
                                            <td>{{$i+1}}</td>
                                            <td>{{App\Siswa::where('NIS', $psb[$i]->NIS)->first()->nama_siswa}}</td>
                                            <td>{{App\Kelas::where('id_kelas', App\Siswa::where('NIS', $psb[$i]->NIS)->first()->id_kelas)->first()->nama_kelas}}</td>
                                            <td>{{App\Rincian::where('id_rincian', $psb[$i]->id_rincian)->first()->detail_rincian}}</td>
                                            <td>{{$psb[$i]->tgl_pembayaran}}</td>
                                            <td>
                                                @if($psb[$i]->status_pembayaran == 1)
                                                    <button class="btn btn-success">Lunas</button>
                                                @endif
                                                @if($psb[$i]->status_pembayaran == 0)
