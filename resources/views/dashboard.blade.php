...
<html lang="en">
<head>
	<title>Sistem Pembayaran Pondok Pesantren Cerdas</title>
	<meta charset="UTF-8">
...
<body>
	...
	<header class="header-section">
		...
		<nav>
			<ul class="menu-list">
				...
				<li><a href="/detail_pembayaran">Detail Pembayaran</a></li>
	...
	<div class="hero-section">
		...
		<div id="hero-slider" class="owl-carousel">
			<div class="item  hero-item" data-bg="img/alislah.jpg"></div>
			<div class="item  hero-item" data-bg="img/alislah2.jpg"></div>
		</div>
	</div>
	<!-- Intro Section -->
...
<!-- 		<div class="overlay"></div>
 -->		<!-- card section -->
				...
				<div class="row">
					...
					<a href="/login">
						...
						<div class="lab-card">
							...
							<h2>Bendahara 1</h2>
							<p>Mengelola pembayaran untuk siswa baru</p>
						</div>
					</div>
					</a>
					...
					<div class="col-md-4 col-sm-6">
						<div class="lab-card">
							...
							<h2>Bendahara 2</h2>
							<p>Mengelola pembayaran spp bulanan</p>
						</div>
					</div>
					<!-- single card -->
					</a>
					...
					<a href="/login">
						...
						<div class="lab-card">
							...
							<h2>Admin</h2>
							<p>Mengelola seluruh data pembayaran siswa</p>
						</div>
					</div>
					</a>
				</div>
	...
	<!-- <div class="team-section spad">
		...
		<div class="container">
			<div class="section-title">
				<h2>Pengguna aplikasi web SPPC</h2>
			</div>
			<div class="row"> -->
				<!-- single member -->
				<!-- <div class="col-sm-4">
